                  ...
                  if(data.connectionState == ConnectionState.active){
                    if(data.data!.snapshot.exists){
                      ...
                      for(var child in values.values){
                        ...
                        messageModel = MessageModel(name: name, imageUrl: imageUrl, message: message,userId: userId,gallaryImage: galleryImage);
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Visibility(
                                    visible: list[index].userId == FirebaseAuth.instance.currentUser!.uid ? false : true,
                                      ...
                                      itemBuilder: (context)  => [
                                        ...
                                        PopupMenuItem(
                                            child: GestureDetector(
                                              onTap: (){
                                                if(list[index].userId != FirebaseAuth.instance.currentUser!.uid){
                                                  AuthService().sendFriendRequest(list[index].userId, currentUserName,currentUserImage);
                          ...
                          children: [
                            ...
                            IconButton(onPressed: (){
                              if(textEditingController.text.isNotEmpty){
                                AuthService().sendMessage(textEditingController.text,currentUserName,imageUrl,userImage);
                                textEditingController.text  = '';
                              } else {
                                AuthService().sendMessage('',currentUserName,imageUrl,userImage);
                              }
