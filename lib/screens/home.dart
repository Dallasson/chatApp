...
class _HomePageState extends State<HomePage> {
  ...
  void showNotification(String userName) {
    ...
    flutterLocalNotificationsPlugin.show(
        0,
        'Friends Request',
        userName + ' Has accepted your friends request , get started',
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DataSnapshot?>(
      future: AuthService().getNotifications(),
          ...
          if (data.data!.exists) {
            ...
            for (var child in map.values) {
              ...
              if (!isOpen) {
                ...
                AuthService()
                    .updateNotificationStatus(name, time, notificationId);
              } else {
                var notificationId = child['notificationId'];
...
Widget buildTabBar(BuildContext context, FirebaseAuth firebaseAuth,
    List<AcceptedFriendsModel> list) {
  return DefaultTabController(
    length: 3,
    child: Scaffold(
      appBar: AppBar(
        title: Text('Chatty',style: TextStyle(fontFamily: 'source'),),
      ...
      drawer: Theme(
        ...
        data: Theme.of(context).copyWith(canvasColor: Color(0xFF1b1e44)),
      ),
      body: TabBarView(
        children: [
          PublicPage(),
